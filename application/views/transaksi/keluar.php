...
<div class="col-lg-3 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <form method="post" action="<?= site_url('transaksi/keluar'); ?>">
                ...
                <tbody>
                    ...
                    foreach ($details as $detail) : ?>
                        <tr>
                            ...
                            <td onclick="javascript: return confirm('Anda yakin hapus?')"><a href="<?= base_url('transaksi/barang_hapus/') . $detail['id_detail'] . '/keluar' ?>"><i class="icon-trash menu-icon"></i></a></td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
            </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: white;">
            ...
            <div class="modal-body">
                <form method="post" action="<?= site_url('transaksi/selesai/keluar'); ?>">
                    <div class="form-group">
                        <?php
